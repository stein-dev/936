...
export CXX="armv7a-linux-androideab21-clang++"
...
export CFLAGS="-march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -mthumb -O2 -s -static -I ${LE}/include"
export LDFLAGS="-L ${LE}/lib"
